  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
          backgroundColor: m8White,
          indicatorColor: m8Blue.withValues(alpha: 0.12),
          surfaceTintColor: Colors.transparent,
          elevation: 8,
...
class _HomePageState extends State<HomePage> {
  ...
  String get displayName {
    ...
    return (value == null || value.isEmpty) ? 'Teman' : value;
  }
  ...
  Future<void> _loadHomeChats() async {
    try {
      final myPin = widget.user['m8_pin']?.toString().trim() ??
      ...
      final response = await http.get(
        Uri.parse(
          '$apiBase/api/chats?m8_pin=${Uri.encodeComponent(myPin)}',
        ),
        headers: {
      ...
      debugPrint('BJo Home chats error: $e');
    }
  ...
  String _chatName(Map<String, dynamic> chat) {
    ...
    return name.isNotEmpty ? name : other;
  }
  ...
  String _chatPhoto(Map<String, dynamic> chat) {
    ...
    return otherUser['profile_photo_url']?.toString().trim() ?? '';
  }

  String _chatTime(Map<String, dynamic> chat) {
    final value = chat['last_message_time']?.toString() ?? '';
  ...
  Widget _avatar(Map<String, dynamic> chat, {double radius = 24}) {
    final name = _chatName(chat);
    final photo = _chatPhoto(chat);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: m8White.withValues(alpha: 0.95),
          width: 2,
        ),
      ),
      child: CircleAvatar(
                ...
                ...chats.map(
                  (chat) {
                    ...
                    return Padding(
                      ...
                      child: Material(
                        color: unread > 0 ? m8Blue.withValues(alpha: 0.10) : m8White.withValues(alpha: 0.96),
                  ...
                  delegate: SliverChildListDelegate([
                    ...
                    if (bio.isNotEmpty)
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color(0xFFF7F3EA).withValues(alpha: 0.94),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color(0xFFF7F3EA).withValues(alpha: 0.91),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(24),
                            border: Border.all(
                              color: m8White.withValues(alpha: 0.66),
                            ),
                          ),
                          child: Row(
                            children: [
...
class _BJoProfileMediaPageState extends State<BJoProfileMediaPage> {
  ...
  Future<void> _chooseProfileImage(ImageSource source) async {
    try {
      ...
      _showError('Gagal memilih foto profil: $e');
    }
  }

  Future<void> _chooseBackground(ImageSource source) async {
    try {
      final picked = await _picker.pickImage(
        source: source,
        imageQuality: 88,
        ...
        return SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  profile ? 'Foto Profil' : 'Background Profil',
                  style: const TextStyle(
                    color: m8BlueDark,
                    fontSize: 21,
                    fontWeight: FontWeight.w900,
                ...
                ListTile(
                  ...
                  onTap: () {
                    ...
                    if (profile) {
                      _chooseProfileImage(ImageSource.gallery);
                    } else {
                      _chooseBackground(ImageSource.gallery);
                    }
                  },
                ),
                ListTile(
                  ...
                  onTap: () {
                    ...
                    if (profile) {
                      _chooseProfileImage(ImageSource.camera);
                    } else {
                      _chooseBackground(ImageSource.camera);
                    }
                  },
                ),
              ],
  ...
  ImageProvider? get _profileProvider {
  ...
  ImageProvider? get _backgroundProvider {
    if (_backgroundImage != null) {
      return FileImage(File(_backgroundImage!.path));
    }
        ...
        children: [
          ...
          Positioned(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                onTap: () => _showSourcePicker(profile: false),
                child: const Padding(
          ...
          Align(
            ...
            child: Column(
              ...
              children: [
                GestureDetector(
                  onTap: () => _showSourcePicker(profile: true),
                  child: Stack(
                    alignment: Alignment.bottomRight,
                    children: [
                      Container(
  ...
  Future<String> _uploadImage(XFile image) async {
    ...
    if (bytes.length > 5 * 1024 * 1024) {
      throw Exception('Gambar terlalu besar. Maksimal 5 MB.');
    }
    ...
    if (url == null || url.isEmpty) {
      throw Exception('Server tidak memberikan URL gambar.');
    }
          ...
          children: [
            ...
            _optionCard(
              ...
              subtitle: _profileImage == null
                  ? 'Ganti dan atur foto profil'
                  : 'Foto baru sudah dipilih',
              onTap: () => _showSourcePicker(profile: true),
            ),
            ...
            _optionCard(
              ...
              subtitle: _backgroundImage == null
                  ? 'Ganti gambar latar profil'
                  : 'Background baru sudah dipilih',
              onTap: () => _showSourcePicker(profile: false),
            ),
